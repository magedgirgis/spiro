...
<body>
    ...
    <div class="container-fluid bg-primary hero-header mb-5">
        <div class="container text-center">
            <h1 class="display-4 text-white mb-3 animated slideInDown">خدماتنا</h1>
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="feature-item position-relative bg-primary text-center p-3">
                        <div class="border py-5 px-3">
                            ...
                            <h5 class="text-white mb-0"> تمنحك الانتعاش والنكهة الفريدة</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="feature-item position-relative bg-primary text-center p-3">
                        <div class="border py-5 px-3">
                            <i class="fa fa-cogs slash fa-3x text-dark mb-4"></i>
                            <h5 class="text-white mb-0">تصميم وتطوير نكهات جديدة</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="feature-item position-relative bg-primary text-center p-3">
                        <div class="border py-5 px-3">
                            <i class="fa fa-shopping-basket fa-3x text-dark mb-4"></i>
                            <h5 class="text-white mb-0">توريد مكونات نكهات عالية الجودة</h5>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="text-primary mb-3"><span class="fw-light text-dark">أهم فوائد للنكهات التي تقدمها الشركة</span>
                سبيروسباتس
                </h1>
            </div>
            <div class="row g-4 align-items-center">
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="row g-5">
                        <div class="col-12 d-flex">
                            ...
                            <div class="ps-3">
                                <h5>توفير تجربة طعام طبيعية ومميزة.</h5>
                        ...
                        <div class="col-12 d-flex">
                            ...
                            <div class="ps-3">
                                <h5>استخدام مكونات طبيعية وخالية من المواد الكيميائية الضارة.</h5>
                                <hr class="w-25 bg-primary my-2">
                                <span></span>
                            </div>
                        </div>
                        <div class="col-12 d-flex">
                            ...
                            <div class="ps-3">
                                <h5>إضافة نكهة غنية وعميقة للأطعمة والمشروبات.</h5>
                                <hr class="w-25 bg-primary my-2">
                                <span></span>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid animated pulse infinite" src="../img/13r.png">
                </div>
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="row g-5">
                        <div class="col-12 d-flex">
                            ...
                            <div class="ps-3">
                                <h5>تعزيز القيم الغذائية والصحية للأطعمة.</h5>
                                <hr class="w-25 bg-primary my-2">
                                <span></span>
                            </div>
                        </div>
                        <div class="col-12 d-flex">
                            ...
                            <div class="ps-3">
                                <h5>دعم الزراعة المستدامة وحماية البيئة.</h5>
                                <hr class="w-25 bg-primary my-2">
                                <span></span>
                            </div>
                        </div>
                        <div class="col-12 d-flex">
                            ...
                            <div class="ps-3">
                                <h5>توفير خيارات للأشخاص الذين يعانون من حساسية للمواد الصناعية.</h5>
                                <hr class="w-25 bg-primary my-2">
                                <span></span>
                            </div>
                        </div>
